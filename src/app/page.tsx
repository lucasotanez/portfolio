...
export default function Home() {
  return (
    <main>
      <div id='top' className="md:pt-40 pt-16 bg-sky-700 text-mint-cream pb-6 sm:pb-24">
        <div className="flex flex-col items-center justify-center pt-12">

          <div id='intro-wrapper' className="relative scale-50 md:scale-100">
          ...
          <p className="sm:mt-28 mt-8 mb-0 text-2xl md:text-3xl text-center">Engineering lightning fast and elegant software solutions.</p>
