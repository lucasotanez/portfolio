  ...
  return (
    <div id="projects" className="pt-32 w-full flex flex-col items-center justify-center text-mint-cream bg-sky-700">
      ...
      <div id="projects-list" className="max-w-4xl sm:w-2/3 lg:w-1/2 w-80 flex flex-col items-center justify-center text-center m-auto">
        ...
        <div className="project m-auto flex flex-col items-center justify-center text-left mb-20">
          <div className="flex flex-row items-center justify-center mx-4">
            <p className="text-4xl drop-shadow-lg font-bold">PAYWALL SENTRY</p>
          ...
          <div className="mt-4 mb-10 text-lg flex flex-row items-center justify-center mx-4">
        ...
        <div className="project m-auto flex flex-col items-center justify-center text-left mb-20">
          <div className="flex flex-row items-center justify-center mx-4">
            <p className="text-4xl drop-shadow-lg font-bold">LINTERVIEW</p>
        ...
        <div className="project m-auto flex flex-col items-center justify-center text-left mb-20">
          <div className="flex flex-row items-center justify-center mx-4">
            <p className="text-4xl drop-shadow-lg font-bold">ICARUS FREESTYLE</p>
        ...
        <div className="project m-auto flex flex-col items-center justify-center text-left mb-20">
          <div className="flex flex-row items-center justify-center mx-4">
            <p className="text-4xl drop-shadow-lg font-bold">DIGIT OCR</p>
          ...
          <div className="group">
            ...
            <div className="z-10 top-0 translate-y-2 group-hover:rotate-3 
              ...
              <p className="pointer-events-none mx-8 sm:mx-12 my-4 sm:text-md md:text-xl text-sm">
                ...
                required the creation of a "big int" class (and operations) 
          ...
          <div className="mt-4 mb-10 text-lg mx-4">
